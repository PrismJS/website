...
<pre data-src="{{ plugins_url }}/toolbar/prism-toolbar.js" data-label="Hello World!"></pre>
```
...
<pre data-src="{{ plugins_url }}/toolbar/prism-toolbar.js" data-label="my-label-button"></pre>
```
